  ...
  return (
    <PageTransition>
      <div className="space-y-4">
        {/* Mobile: two-row controls (search + add, then filters) */}
        <div className="sm:hidden bg-card border border-border/60 p-2 rounded-lg shadow-sm space-y-2">
          <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2">
            <div className="relative min-w-0">
              <IconSearch className="absolute left-2.5 top-1/2 size-3.5 -translate-y-1/2 text-muted-foreground z-10" />
              <Input
                type="text"
        ...
        {/* Desktop/tablet: single-row controls */}
        <div className="hidden sm:grid sm:grid-cols-[2fr_1.2fr_1.2fr_1.2fr_auto] items-center gap-2 bg-card border border-border/60 p-2 rounded-lg shadow-sm">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3">
                          ...
                          <div className="flex items-center gap-2.5 min-w-0 flex-1">
                            ...
                            >
                              {selectedIds.includes(d.id) && (
                                <svg
                                  className="size-2.5 fill-none stroke-current stroke-[3.5px]"
                                  viewBox="0 0 24 24"
                                >
                            ...
                            {d.category ? (
                              <span className="bg-muted text-muted-foreground border border-border px-2 py-0.5 rounded-md font-bold uppercase tracking-wider text-[9px] leading-none shrink-0">
                                {contentCategoryLabelMap[d.category] ??
                                  d.category}
                              </span>
                            ) : null}
                          </div>
